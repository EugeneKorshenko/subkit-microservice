...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.buildFrom1_1Spec = function(response) {
      var api, isApi, newName, operation, res, resource, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
      console.log("This API is using a deprecated version!");
      if (response.apiVersion != null) {
        this.apiVersion = response.apiVersion;
      }
      this.apis = {};
  ...
  BasicAuthorization = (function() {
    ...
    BasicAuthorization.prototype.username = null;

    BasicAuthorization.prototype.password = null;
    ...
    BasicAuthorization.prototype.apply = function(obj) {
        var encoded = btoa(unescape(encodeURIComponent([this.username, this.password].join(':'))));
        return obj.headers["Authorization"] = "Basic " + encoded;
    };
