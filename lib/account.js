...
module.exports.init = function(server, account, helper, doc){
	var account_doc = doc("account", "Account operations.");
	...
	server.get("/account/settings", helper.apiAuth, function(req, res, next){
		res.send(200, {});
	});
