...
module.exports.init = function(server, storage, identity, helper){
	...
	//identity ops
	server.get("/identity/login/:identityId", helper.apiAuth, function(req, res, next){
	...
	//groups
	server.get("/identity/groups", helper.apiAuth, function(req, res, next){
	...
	server.get("/identity/groups/users", helper.apiAuth, function(req, res, next){
		storage.read("identities", {}, function(err, data){
			if(err) return res.send(500, err);
			var groups = data.reduce(function(state, event){
				var userGroups = event.value.groups || [];
	...
	server.get("/identity/groups/:groupId", helper.apiAuth, function(req, res, next){
	...
	//identity group
	server.get("/identity/:identityId/groups", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
	...
	server.put("/identity/:identityId/groups/:groupid", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
		var groupid = req.params.groupid;
	...
	server.del("/identity/:identityId/groups/:groupid", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
		var groupid = req.params.groupid;
		var metadata = req.body;
	...
	//identity
	server.get("/identity/:identityId", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
	...
	server.get("/identity", helper.apiAuth, function(req, res, next){
		...
		else identity.load(_response);
	});
	server.post("/identity", helper.apiAuth, function(req, res, next){
		identity.create(function(err, data){
			if(err) return res.send(500, err);
			res.send(201, { status: "created" });
		});
	});
	server.post("/identity/:identityId", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
	...
	server.put("/identity/:identityId", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
	...
	server.del("/identity/:identityId", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
