...
module.exports.init = function(server, storage, helper){
	...
	server.get("/identities/validate/:identityId", function(req, res, next){
	...
	server.get("/identities/:groupId", helper.apiAuth, function(req, res, next){
	...
	server.post("/identities/groups/:groupId/:identityId", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
		var groupId = req.params.groupId;
	...
	server.del("/identities/groups/:groupId/:identityId", helper.apiAuth, function(req, res, next){
		var identityId = req.params.identityId;
		var groupId = req.params.groupId;
