...
module.exports.init = function(config, storage){
	...
	var _findAll = function(callback){
		storage.read("identities!devices", {}, callback);
	};
	...
	var _sendMPNS = function(deviceToken, message, payload){
		var pushUri = "http://db3.notify.live.net/throttledthirdparty/01.00/" + "AQHaXMAW1mZbRoHFxQuiQ4X2AgAAAAADBQAAAAQUZm52OjlDMTM0RTBBNkJDQ0U2MUUFBkVVV0UwMQ";
		mpns.sendToast(pushUri, 'Bold Text', 'This is normal text', function(){
