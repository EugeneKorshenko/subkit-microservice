...
module.exports.init = function(conf, pubsub){
	...
	var _grantInsertAccess = function(name, identity, callback){
		if(!callback) callback = function(){};
		if(name.indexOf('/') !== 0) name = '/'+name;
	...
	var _grantUpdateAccess = function(name, identity, callback){
		if(!callback) callback = function(){};
		if(name.indexOf('/') !== 0) name = '/'+name;
	...
	var _revokeInsertAccess = function(name, identity, callback){
		if(!callback) callback = function(){};
		if(name.indexOf('/') !== 0) name = '/'+name;
	...
	var _revokeUpdateAccess = function(name, identity, callback){
		if(!callback) callback = function(){};
		if(name.indexOf('/') !== 0) name = '/'+name;
	...
	return {
		...
		grantInsertAccess: _grantInsertAccess,
		grantUpdateAccess: _grantUpdateAccess,
		grantDeleteAccess: _grantDeleteAccess,
		revokeReadAccess: _revokeReadAccess,
		revokeInsertAccess: _revokeInsertAccess,
		revokeUpdateAccess: _revokeUpdateAccess,
