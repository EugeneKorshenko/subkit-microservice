...
module.exports.init = function(conf){
	...
	var create = function(resource, key, payload, callback){
	...
	//manage
	var imports = function(resource, payload, callback){
		var data = [];
	...
	var exports = function(resource, callback){
		var elements = [];
		db.createReadStream()
