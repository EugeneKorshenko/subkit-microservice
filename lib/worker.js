...
module.exports.init = function(server, worker, helper){

	server.get(/worker\/run\/([a-zA-Z0-9_\.~-]+)/, helper.apiAuth, function (req, res, next) {
	...
	server.put(/worker\/exec\/([a-zA-Z0-9_\.~-]+)/, helper.apiAuth, function (req, res, next) {
