...
*/
module.exports = function (config, storage, pubsub, es, template, file, doc) {
	module.exports.init(config, storage, pubsub, es, template, file, doc);
};
module.exports.init = function(conf, storage, pubsub, es, template, file, doc){
