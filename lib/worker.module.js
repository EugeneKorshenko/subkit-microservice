...
*/
module.exports = function (config, storage, pubsub, es, doc) {
	module.exports.init(config, storage, pubsub, es, doc);
};
module.exports.init = function(conf, storage, pubsub, es, doc){
